...
class GifScreenState extends State<GifScreen> {
  ...
  Future<void> fetchGifs(String query, {bool isFirst = false}) async {
    ...
    final response = await http.get(
      Uri.parse('https://api.giphy.com/v1/gifs/search?api_key=$apiKey&q=$query&limit=$limitSearching&offset=$offsetSearching'),
    );
  ...
  Future<void> fetchTrendingGifs() async {
    ...
    final response = await http.get(
      Uri.parse('https://api.giphy.com/v1/gifs/trending?api_key=$apiKey&limit=$limitTrending&offset=$offsetTrending'),
    );
