...
class StickerScreenState extends State<StickerScreen> {
  ...
  Future<void> addCustomSticker() async {
    ...
    if (image != null) {
      setState(() {
        stickerMessages.add(image.path);
      });
    }
  }
  ...
  void removeSticker(int index) {
    setState(() {
      stickerMessages.removeAt(index);
    });
  }
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () async {
                  ...
                  if (editedStickerPath != null) {
                    setState(() {
                        stickerUrls.add(editedStickerPath);
                    });
                  }
                  Navigator.pop(context);
                },
              ...
              if (!stickerUrl.startsWith("http"))
                ListTile(
                  ...
                  onTap: () {
                    if (stickerMessages.contains(stickerUrl)) {
                      removeSticker(stickerMessages.indexOf(stickerUrl));
                    }
                    Navigator.pop(context);
                  },
                ),
                        ...
                        GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              ...
                              child: stickerUrls[index].startsWith("http") ? CachedNetworkImage(
